...
pub fn zigAddResource(
    ...
    // Get 10 strings + 3 optional (blocks + array)
    _ = mruby.mrb_get_args(mrb, "SSSSSSSSSS|ooA", &name_val, &uri_val, &key_url_val, &key_path_val, &distribution_val, &components_val, &arch_val, &options_val, &repo_type_val, &action_val, &only_if_val, &not_if_val, &notifications_val);
